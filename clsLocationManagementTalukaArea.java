...
public class clsLocationManagementTalukaArea
{
	...
	public static void showLocationManagementTalukaArea(clsLocationManagementTalukaArea temp)
	{
	...
	{
		return (dlsLocationManagementTalukaArea.getLocationInfo(mAreaID));
	}
	public static void main (String []args)
	{
		clsLocationManagementTalukaArea temp = clsLocationManagementTalukaArea.getLocationInfo(1);
		showLocationManagementTalukaArea(temp);
	}
