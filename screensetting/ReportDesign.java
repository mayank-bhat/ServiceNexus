...
public class ReportDesign extends JPanel
{
	...
	public ReportDesign()
	{
		...
		pnlButton.setBackground(ColorSetting.getBackColorCenterBottomButtonPanel());
		...
		pnlInfo1.setBackground(ColorSetting.getBackColorLeftPanel());
		pnlInfo2.setBackground(ColorSetting.getBackColorLeftPanel());
		pnlInfo3.setBackground(ColorSetting.getBackColorLeftPanel());
		pnlInfo4.setBackground(ColorSetting.getBackColorLeftPanel());
		pnlInfo5.setBackground(ColorSetting.getBackColorLeftPanel());
		pnlInfo6.setBackground(ColorSetting.getBackColorLeftPanel());
		pnlInfo7.setBackground(ColorSetting.getBackColorLeftPanel());
		...
		//lblProject.setText(ScreenDesign.getProgramHeadingLabel());
